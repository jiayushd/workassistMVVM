...
{
    class SQLiteDataService : IKPIService
    {
        ...
        public double GetFirstVersionWeight(List<string> names)
        {
            throw new NotImplementedException();
        }

        public double GetDonePoint(List<string> names)
        {
            throw new NotImplementedException();
        }

        public double GetPatentDegree(List<string> names)
        {
            throw new NotImplementedException();
        }

        public double GetIntimeRatio(List<string> names)
        {
            throw new NotImplementedException();
        }
    }
